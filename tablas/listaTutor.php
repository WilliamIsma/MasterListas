...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="table-responsive">
    <table class="table align-items-center mb-0">
      <thead>
        <tr>
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Identificador Tutor</th>
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nombre Completo</th>
          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Denominacion </th>
      ...
      <tbody>
        <tr> <!-- aqui empieza la tabla-->
          <td>
          <p class="text-xs text-secondary mb-0">1929POAL</p>
          </td>
          <td>
            <div class="d-flex px-2 py-1">
              
              <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 text-xs">John Michael Alfaro Escalante</h6>
              </div>
            </div>
          </td>

          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">Denominacion</span>
          </td>
        </tr>
