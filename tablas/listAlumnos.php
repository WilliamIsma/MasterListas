...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="table-responsive ">
    <table class="table align-items-center mb-0 ">
      <thead>
        <tr>
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">No Cuenta</th>
          ...
          <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Carrera</th>
          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tutor</th>
          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Dependecias</th>
          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Formatos</th>
          <th class="text-secondary opacity-7"></th>
        </tr>
      </thead>
      <tbody>
        <tr class=".scroll-x container"> <!-- aqui empieza la tabla-->
          <td>
          <p class="text-xs text-secondary mb-0">1929116</p>
          </td>
          <td>
            <div class="d-flex px-2 py-1">
              ...
              <div class="d-flex flex-column justify-content-center">
                ...
                <p class="text-xs text-secondary mb-0">john@creative-tim.com</p> <!--Correo-->
              </div>
            </div>
          </td>

          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">Hombre</span>
          </td>

          <td>
            <p class="text-xs font-weight-bold mb-0">(55)4950 4312</p>
          </td>
          <td class="align-middle text-center text-sm" > 
            <span class="badge badge-sm badge-success">Ing Computacion</span>
          </td>
          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">Fabian</span>
          </td>

          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">Universidad</span>
          </td>
        ...
        <tr> <!-- aqui empieza la tabla-->
          ...
          <td>
            <div class="d-flex px-2 py-1">
              ...
              <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 text-xs">William Ismael MEndez Chavez</h6>
                <p class="text-xs text-secondary mb-0">john@creative-tim.com</p> <!--Correo-->
              </div>
            </div>
          </td>
          ...
          <td>
            <p class="text-xs font-weight-bold mb-0">(55)4950 9812</p>
          </td>
          <td class="align-middle text-center text-sm" > 
            <span class="badge badge-sm badge-success">Ing Computacion</span>
          </td>
