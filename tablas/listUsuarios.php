    ...
    <table class="table align-items-center mb-0 r">
      <thead>
        <tr>
          ...
          <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Correo</th>
      ...
      <tbody >
        <tr class="container"> <!-- aqui empieza la tabla-->
          <td>
          <p class="text-xs  text-center text-secondary mb-0">189471</p>
          </td>
          <td>
            <div class="d-flex px-2 py-1">
              
              <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 text-center text-xs">John </h6>
              </div>
            </div>
          </td>

          <td class="align-middle text-center">
            <span class="text-secondary text-center text-xs font-weight-bold">Ramirez</span>
          </td>

          <td>
            <p class="text-xs  text-center font-weight-bold mb-0">Cruz</p>
          </td>
          <td class="align-middle text-center text-sm" > 
            <span class="badge badge-sm badge-success">fabianP@gmail.com</span>
          </td>
          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">AlaMediometro</span>
          </td>
        ...
        <td>
          <p class="text-xs text-center text-secondary mb-0">1879H41</p>
          </td>
          <td>
            <div class="d-flex px-2 py-1">
              
              <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 text-xs">Julion</h6>
              </div>
            </div>
          </td>

          <td class="align-middle text-center">
            <span class="text-secondary text-center text-xs font-weight-bold">Alvares</span>
          </td>

          <td>
            <p class="text-xs font-weight-bold text-center mb-0">Paz</p>
          </td>
          <td class="align-middle text-center text-sm" > 
            <span class="badge badge-sm badge-success">JuionAlvarezP@gmail.com</span>
          </td>
          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">Cachondo</span>
          </td>

          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">Consumidor</span>
          </td>
        </tr>
      </tbody>
    </table>
