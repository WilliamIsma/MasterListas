...
<body class="g-sidenav-show bg-gray-100">
      ...
      <div class="container-fluid py-1">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="text-white opacity-5" href="javascript:;">Lista</a></li>
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Carrera</li>
          </ol>
          <h6 class="text-white font-weight-bolder ms-2">Carrera</h6>
        </nav>
  ...
  <div class="table-responsive">
    <table class="table align-items-center mb-0">
      <thead>
        <tr>
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Identificador Carrera</th>
          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nombre </th>
          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Abrebiatura</th>
      ...
      <tbody>
        <tr> <!-- aqui empieza la tabla-->
          <td>
          <p class="text-xs text-secondary mb-0">Ing1547</p>
          </td>
          <td>
            <div class="d-flex px-2 py-1">
              
              <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 text-xs">Ingenieria en Computacion</h6>
              </div>
            </div>
          </td>

          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">ICO</span>
          </td>
        </tr>

        <tr> <!-- aqui empieza la tabla-->
        <td>
          <p class="text-xs text-secondary mb-0">LIC874</p>
          </td>
          <td>
            <div class="d-flex px-2 py-1">
              
              <div class="d-flex flex-column justify-content-center">
                <h6 class="mb-0 text-xs">Lisenciatura en contabilidad</h6>
              </div>
            </div>
          </td>

          <td class="align-middle text-center">
            <span class="text-secondary text-xs font-weight-bold">CONTA</span>
          </td>
        </tr>
      </tbody>
    </table>
